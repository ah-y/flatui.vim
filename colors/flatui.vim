...
if &background=="light"
	let s:comment={"gui": "#ba8f02", "cterm": "70"}
	let s:bg={"gui": "#f5f5fa", "cterm": "255"}
	let s:function={"gui": "#066f7a", "cterm": "0"}
	let s:cursor={"gui": "#040236", "cterm": "0"}
	let s:preproc={"gui": "#ff8000", "cterm": "202"}
	let s:keyword={"gui": "#0b237a", "cterm": "0"}
	let s:special=s:pumpkin
  ...
  let s:darkAccent7=s:pomegranate
	...
	let s:comment={"gui": "#547d65", "cterm": "98"}
	let s:bg={"gui": "#181b24", "cterm": "0"}
   let s:function={"gui": "#83e900", "cterm": "98"}
   let s:cursor=s:sunFlower
   let s:preproc={"gui": "#ff8000", "cterm": "255"}
	let s:keyword={"gui": "#4270ff", "cterm": "255"}
	let s:special=s:sunFlower
  let s:norm=s:clouds
...
" Highlights - UI ------------------------------------------{{{
  ...
  call s:h("Cursor",       { "fg": s:cursor, "bg": s:lightNorm })
  ...
  call s:h("Directory",    { "fg": s:darkAccent6 })
...
" Highlights - Generic Syntax ------------------------------{{{
  ...
  call s:h("Type",       { "fg": s:lightAccent4, "gui": "bold", "cterm": "bold" })

  call s:h("Special",    { "fg": s:special, "gui": "bold", "cterm": "bold" })
